  ...
  return (
    ...
    md:px-16 lg:px-36 py-5'>
      <Link to='/' className='max-md:flex-1'>
        <h1 className='text-4xl max-md:text-lg font-bold bg-gradient-to-r from-[#20B2AA] to-yellow-300/50 bg-clip-text text-transparent'>
          Go Cinema
        </h1>
      </Link>
      ...
      <div className='flex items-center gap-8'>
        <div className="relative">
          ...
          {showSearch && (
            <div className="absolute right-0 max-md:left-0 mt-3 w-80 bg-black/80 backdrop-blur p-3 rounded-lg border border-primary">
              <input
                type="text"
                autoFocus
                value={searchTerm}
