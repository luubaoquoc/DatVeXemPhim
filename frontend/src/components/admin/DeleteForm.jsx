...
const DeleteForm = ({ itemName = "item", onDelete }) => {
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-black/90 border border-primary p-6 rounded-lg w-[350px] shadow-lg">
            <h2 className="text-lg font-semibold mb-3">
              Xác nhận xoá <span className="text-lg text-primary">{itemName}</span>
            </h2>

            <p className="text-gray-300 mb-5">
              Bạn có chắc chắn muốn xoá <span className="text-primary">{itemName}</span> này không?
            </p>
