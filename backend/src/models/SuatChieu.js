...
const SuatChieu = sequelize.define('SuatChieu', {
  maSuatChieu: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
  maPhim: { type: DataTypes.INTEGER, allowNull: false },
  ...
  giaVeCoBan: { type: DataTypes.DECIMAL(10, 2), allowNull: false }
}, {
